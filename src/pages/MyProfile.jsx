  ...
  return userData && (
    <div className='max-w lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_7.8fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='font-medium'>phone:</p>
          {
           ...
           <p className='font-medium'>Address:</p>
           {
            isEdit?
            <p>
              <input className='bg-gray-50' type="text" onChange={(e) => setUserData({...prev, address:{...prev.address, line1: e.target.value} })} value={userData.address.line1}/>
              <br />
              <input className='bg-gray-50' type="text" onChange={(e) => setUserData({...prev, address:{...prev.address, line2: e.target.value} })} value={userData.address.line2}/>
            </p>:
